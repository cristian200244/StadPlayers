    ...
    public function getAll()
    {
        ...
        try {
            ...
            while ($row = $query->fetch()) {
                ...
                $item->id_pais = $row['id_pais'];
                $item->id_continente = $row['id_continente'];
    ...
    public function store($datos)
    {
        ...
        try {
            ...
            $query = $prepare->execute([
                ...
                'id_continente' => $datos['id_continente'],
