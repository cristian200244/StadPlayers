                        ...
                        <div class="card-body p-5 text-center">
                            ...
                            <form id="datos">
                                ...
                                <div class="form-group mb-2 px-2">
                                    <input type="email" id="email" value=" " name="email" placeholder="Correo" class="form-control form-control-lg" />
                                    <strong><label class="form-label" for="typeEmailX-2" style=" color:#9bdaff;">Ingresa
                                            un
                                            Correo</label></strong>
                                </div>
                                <div class="form-group mb-4">
                                    <input class="form-control form-control-lg" id="nickname" value="" placeholder="Nickname" type="text" name="nickname">
                                    <strong><label class="form-label" for="nickname" style="font-family:Russo One; color:#9bdaff;">Nickname</label></strong>
                                </div>

                                <div class="form-outline mb-2 px-2">
                                    <input type="password" id="password" value="" name="password" placeholder="Contraseña" class="form-control form-control-lg" />
