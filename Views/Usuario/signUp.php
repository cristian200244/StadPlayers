...
<section class="vh-110" style="background-color:#48C9B0;">
    <form action="UsuarioLoginController.php" method="post">
                    ...
                    <div class="card shadow-2-strong card bg-black" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center">
                            ...
                            <div class="form-group mb-2 px-2">
                                ...
                                <strong></strong> <label class="form-label" for="typeEmailX-2" style=" color:#9bdaff;">Ingresa un Correo</label></strong>
                            </div>

                            <div class="form-outline mb-2 px-2">
                                <input type="password" id="typePasswordX-2" class="form-control form-control-lg" />
                                <label class="form-label" for="typePasswordX-2" style="font-family:Russo One; color:#9bdaff;">Elige una Contraseña</label>
                            </div>
                            <div class="form-outline mb-2 px-2">
                                <input type="password" id="typeEmailX-2" class="form-control form-control-lg" />
                                <strong></strong> <label class="form-label" for="typePasswordX-2" style="font-family:Russo One; color:#9bdaff;">Confirma tu
                                    Contraseña</label></strong>
                            </div>

                            <form class="iniciarSesion">

                                <a type="submit" class="btn btn-outline-light btn-lg px-2 fs-5 bg-light text-warning" href="<?= BASE_URL ?>/index.php">
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                    <span></span>
