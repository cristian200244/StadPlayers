        ...
        <div class="container" style="margin-top: 15%;">
            <div class="col-lg-11">
                <div class="card shadow-lg border-0 bg-light rounded-lg mt-5">
                    ...
                    <div class="card d-flex bg-white  text-center py-3 px-3">
                        ...
                        <div class="row mb-3 ms-5">
                            ...
                            <div class="card col-3 col-sm-3 bg-black ms-4 me-3  mt-3 pt-2 pb-2 text-white">
                                <strong>
                                    <h5><label>
                                            <?= str_replace("_", " ", $key) ?>
                                        </label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-5 ms-3">
                                <div class="row ms-3">
                                    <div class="card shadow-lg bg-info me-3 border-0 rounded-lg mt-5  p-2"
                                        id="EstadArquero">
