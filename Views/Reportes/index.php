...
<div class="imgGenReport">
    <main>
        <div class="card mb-4 p-3 ms-5 me-5 bg-secondary" style="margin-top:15%">
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= BASE_URL ?>/Views/Reportes/VerReporteIndividual.php" class="btn btn-sm btn-outline-info">Ver</a>
                                        <a href="personas/VerReportes.php?id=<?php echo $registro->id; ?>" class="btn btn-sm btn-outline-warning">Editar</a>
