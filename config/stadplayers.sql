...
-- Tiempo de generación: 12-06-2023 a las 19:30:57
...
INSERT INTO `estadisticas_encuentro` (`id`, `fecha_del_partido`, `id_tipo_partido`, `id_jugador`, `id_equipo`, `id_liga`) VALUES
(1, '2017-04-26', 1, 1, 1, 1),
(2, '2018-07-10', 2, 2, 3, 2),
(3, '2023-05-10', 3, 2, 5, 4),
(4, '2023-06-12', 1, 6, 1, 1),
(5, '2023-06-25', 1, 6, 1, 1),
(6, '2023-08-03', 1, 6, 1, 1),
(7, '2023-10-10', 1, 6, 1, 1),
(8, '2022-02-02', 1, 1, 3, 1),
(9, '2022-05-12', 1, 1, 4, 1),
(10, '2022-07-27', 1, 1, 5, 1),
(11, '2022-09-08', 1, 1, 6, 1),
(12, '2023-03-28', 1, 1, 1, 1),
(13, '2021-02-10', 1, 2, 2, 1),
(14, '2021-04-13', 1, 2, 3, 1),
(19, '2021-05-02', 1, 5, 1, 1),
(20, '2022-05-10', 1, 5, 1, 1),
(21, '2023-11-13', 1, 5, 1, 1),
(22, '2022-02-20', 2, 6, 6, 3),
(23, '2022-03-10', 2, 6, 6, 3),
(24, '2023-05-28', 3, 6, 6, 3);
...
(25, '2017-04-26', '2023-03-28', 1, 1),
(26, '2018-02-22', '2022-12-10', 1, 1),
(28, '2023-06-12', '2023-10-10', 6, 1),
(30, '2023-06-12', '2023-10-10', 6, 1),
(31, '2023-06-12', '2023-10-10', 1, 1),
(32, '2023-06-12', '2023-10-10', 6, 1),
(36, '2021-05-02', '2023-11-13', 5, 1),
(37, '2021-08-10', '2023-09-10', 5, 1),
(38, '2022-02-20', '2023-05-28', 6, 1);
...
INSERT INTO `jugadores` (`id`, `nombre_completo`, `apodo`, `fecha_nacimiento`, `id_usuario`, `id_equipo`, `id_liga`, `id_pais`, `id_contiente`, `id_posicion`, `id_perfil`) VALUES
(1, 'Rosito Mañaneiros', 'El 3am', '1999-10-14', 1, 3, 1, 5, 3, 6, 1),
(2, 'David Hernandez', 'La Cachaza', '1998-08-23', 2, 4, 1, 3, 1, 5, 1),
(5, 'Kevin Mier', 'La Araña', '2000-02-15', 1, 1, 1, 4, 1, 1, 1),
(6, 'Dorlan Pavon', 'Memín', '2000-05-22', 1, 1, 1, 3, 1, 9, 1),
(7, 'Albert Hass', 'El lentejo', '1999-12-23', 1, 5, 4, 8, 2, 3, 1),
(8, 'Alan Brito Delgado', 'El Flaco', '2003-05-02', 3, 3, 2, 4, 1, 5, 2),
(9, 'Guillermo Nigote', 'El Nadies', '2008-07-06', 3, 7, 5, 8, 4, 9, 2),
(10, 'Elvio Lao', 'El suave', '2005-08-10', 2, 4, 5, 6, 4, 10, 2),
(11, 'Aquiles Castro', 'La Gillotina', '2008-09-17', 2, 5, 3, 7, 5, 11, 1);
...
(9, 'danitalareina@gmail.com', 'danita12', '$2y$10$kqrWSXkD1JXEuXWbm4yd6Ok.Avh43FKfFEAPOgHuyh44c7vz.kZT6'),
(12, 'josecanseco@gmail', 'danita12', '$2y$10$jN7bQvAgwb.1NCPTP1q7Su6nkfGRO5.WNnoGjbltZSyrbQK7ddIpC');
...
--
ALTER TABLE `estadisticas_count`
  ADD CONSTRAINT `FK_encuentro_estad_id_count_estadisticas_id` FOREIGN KEY (`id_encuentro_estadistica`) REFERENCES `estadisticas_encuentro` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
